...
public abstract class BinaryExpression<T> implements TripleExpressionGeneric<T> {
    private TripleExpressionGeneric<T> left;
    private TripleExpressionGeneric<T> right;
    protected Operation<T> op;

    BinaryExpression(TripleExpressionGeneric<T> left, TripleExpressionGeneric<T> right, Operation<T> op) {
        this.left = left;
        this.right = right;
        this.op = op;
    }
